...
from modules.classes import NowTime, Telegram, unpack_telegram_from_db, NetCDF
...
def test_connect_db(create_db_):
...
def test_query_db(db_insert_24h):
...
@pytest.fixture()
def db_insert_24h_w_gaps(create_db_):
...
def test_NetCDF_w_gaps(db_insert_24h_w_gaps):
    '''
